...
('Employee 1', 'employee1@test.com', 1, '2025-09-01', 1000, null),
('Employee 2', 'employee2@test.com', 1, '2025-09-01', 1000, 1),
('Employee 3', 'employee3@test.com', 2, '2025-09-01', 1000, 1),
('Employee 4', 'employee4@test.com', 3, '2025-09-01', 1000, 2),
('Employee 5', 'employee5@test.com', 3, '2025-09-01', 1000, 3);

INSERT INTO project(name, start_date, end_date, department_id) VALUES
('Project 1', '2025-09-10', '2025-09-15', 1),
('Project 2', '2025-09-10', '2025-09-15', 1),
('Project 3', '2025-09-10', '2025-09-15', 2);
